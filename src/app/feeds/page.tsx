      ...
      <div style={styles.container}>
        ...
        <div style={styles.sidebar}>
          ...
          <nav style={styles.navMenu}>
            <a href="#" style={{...styles.navItem, ...(activeNav === 'home' && styles.navItemActive)}} onClick={() => setActiveNav('home')}>
            ...
            <a href="#" style={styles.navItem} onClick={() => setActiveNav('search')}>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            ...
            <a href="#" style={styles.navItem} onClick={() => setActiveNav('explore')}>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            ...
            <a href="#" style={styles.navItem} onClick={() => setActiveNav('messages')}>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/>
              </svg>
              <span>messages</span>
            </a>
            <a href="#" style={styles.navItem} onClick={() => setActiveNav('notifications')}>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            ...
            <a href="#" style={styles.navItem} onClick={() => setActiveNav('create')}>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            ...
            <a href="#" style={styles.navItem} onClick={() => setActiveNav('profile')}>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            ...
            <a href="#" style={styles.navItem} onClick={() => setActiveNav('work')}>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
